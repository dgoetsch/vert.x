...
+++
|[[enableWebSocketKeepAlive]]`enableWebSocketKeepAlive`|`Boolean`|-
|[[enabledCipherSuites]]`enabledCipherSuites`|`Array of String`|
+++
Add an enabled cipher suite, appended to the ordered suites.
+++
...
+++
|[[webSocketPingIntervalMilli]]`webSocketPingIntervalMilli`|`Number (int)`|-
|[[webSocketPongTimeoutMilli]]`webSocketPongTimeoutMilli`|`Number (int)`|-
|===
